...
import { createPublicClient, encodeFunctionData, getContractAddress, http, numberToHex, ProviderDisconnectedError,  } from "viem";
...
export const sendTransaction = async( provider,fromAddress, contractAddress, paymasterUrl) =>{
    ...
    try {
        if(!provider || !provider.request){
            throw new Error("No Provider avaialble. please connect to a base account")
        ...
        console.log(`Error sending trnsaction : ${error}`)
    }
